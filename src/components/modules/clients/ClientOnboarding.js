...
export default function AddClient() {
  ...
  // Prevent paste for specific fields
  useEffect(() => {
          ...
          {[
            ...
            <div key={field.name} className={`flex flex-col ${field.colSpan ? 'sm:col-span-2' : ''}`}>
              ...
              {field.type === 'textarea' ? (
                ...
                >
                  <SelectTrigger className="border-gray-300 focus:border-green-500 focus:ring-green-500 bg-white text-gray-900 rounded-lg">
