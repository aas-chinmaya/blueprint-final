...
// import { fetchTeamMeetings } from '@/store/features/calender/teammeetingCalenderSlice'; // ✅ your new thunk
// import { formatRange } from '@/utils/formatDate'; // ✅ date formatter
...
//   useEffect(() => {
//     // Replace with the actual logged-in user's email if available
//     const email = 'it_pujarini@outlook.com';
//     dispatch(fetchTeamMeetings(email));
//   }, [dispatch]);
//  console.log('teamMeetings', teamMeetings);
...
import { useDispatch, useSelector } from 'react-redux';
import { fetchTeamMeetings, createTeamMeeting } from '@/store/features/calender/teammeetingCalenderSlice';
